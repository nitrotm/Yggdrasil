...
**Platform-agnostic:** The CLI does not know which agent platform (Cursor, Claude, Copilot) consumes its output. It produces plain text with XML-like tags and exit codes. The platform delivers the mechanism; Yggdrasil delivers the content.
