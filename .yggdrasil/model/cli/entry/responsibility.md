...
- Registering 14 subcommands via `register*Command(program)`: init, build-context, validate, drift, drift-sync, preflight, status, tree, owner, deps, impact, journal-add, journal-read, journal-archive
